        ...
        <div className="row py-md-5">
          <div className="col-md-6 text-center text-md-start" data-aos="fade-left">
            <h1 className="tage-h-one">
              Transforming Your Ideas into Digital Excellence with Cutting-Edge Solutions
            </h1>
            <p className="fn-18 mt-2">
              IND Tech Mark boasts a team of digital transformation specialists with a wide
              range of expertise. We are dedicated to providing custom top-notch digital
              solutions for businesses of all sizes. From innovative web design to its
              development, we create exceptional digital experiences that drive success in
              the field.
            </p>
          </div>
                ...
                <li key={index}>
                  <div className="number_counter">
                    <div className="counter-text">
                      {inView && <CountUp start={0} end={item.number} duration={3} />}+
                    </div>
