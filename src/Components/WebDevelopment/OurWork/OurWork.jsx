...
const OurWorkSection = () => {
  return (
    <section className="bodypx ourworksection bg-dark py-80">
      <div className="container-fluid px-md-0">
        <div className="row">
          {/* Left Column - Heading & Text */}
          <div className="col-md-7 text-center text-sm-start">
            <h2 className="text-white">
              Our Featured Web Development Success Stories
            </h2>
            <p className="text-white">
              Discover our cutting-edge projects that exemplify our dedication
              to delivering transformative web app development services and
              solutions.
            </p>
          </div>
          ...
          <div className="col-md-5 text-end d-sm-block d-none">
            <Link
              to="/portfolio"
              className="btn-white mt-2 mt-xl-3 fw-bold fn-16"
            >
