...
import "./HeroBanner.css"; // Import your custom CSS for HeroBanner
...
const HeroBanner = () => {
  return (
    <section
      className="banner text-white pt-5"
      style={{
        backgroundImage: "url('../../assets/images/banner-bg.jpg')",
        backgroundSize: "cover",
        backgroundPosition: "center",
    ...
    >
      <div className="position-relative uiuxbanner">
        {/* Banner Content */}
        <div className="slidoverlay bodypx">
          <div className="container h-100">
            <div className="row align-items-center py-md-5 h-100">
              <div className="col-lg-9 tracking-in-expand text-center py-5 mx-auto">
                <h1 className="text-white tage-h-one fs-50 fw-bold pt-md-0 pt-4">
                  Top Website Design Company
                </h1>
                <p className="text-white pt-2">
                  Get ready to elevate your business and brand image with the
                  best web design company, IND Tech Mark. We don’t just design
                  websites; we create digital experiences for businesses that
