        ...
        <div className="row align-items-center">
          <div className="col-md-8 col-xl-6 tracking-in-expand py-4">
            ...
            <p className="text-white pe-md-5">
              An enterprising software development organization with intellectual minds at work, devoted
              and skilled to build smart IT solutions for a better tomorrow. Explore business avenues with INDTechMark.
            </p>
        ...
        <div className="row align-items-center position-relative py-lg-5">
          ...
          <div className="col-lg-8">
            <p className="fn-30 fw-200 px-50 ipadpos">
              ...
              products and solutions that provide unmatched business & customer
