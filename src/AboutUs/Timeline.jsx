...
const TimelineSlider = () => {
  return (
    <section className="bodypx bg-red py-80 overflow-hidden position-relative ipadpx">
            ...
            <div className="row">
              ...
              <div className="col-lg-6">
                <div className="px-md-5 px-3 dotbg timelineimg">
                  <img className="w-100 rounded30" src={item.image} alt={`Timeline ${item.year}`} />
                </div>
              </div>
            </div>
          </SwiperSlide>
      ...
      {/* Custom Progress Bar */}
      <div className="progress-container" style={{ width: '30%', backgroundColor: '#ccc', height: '2px', marginTop: '20px', position: 'relative', marginRight:'5rem' }}>
        <div className="progress-bar" style={{ width: '100%', backgroundColor: 'transparent', height: '100%' }}></div>
      </div>
