          ...
          <div className="row">
            <div className="col-sm-6 col-md-6 first-outer">
              <div className="second-inner">
                ...
                <p className="f-22 wow fadeInRight">LET'S TALK AND GET STARTED</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="col-sm-6 col-md-4 outer-col-1 py-5">
              <div className="text272A2E px-4 py-3 rounded-3">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-3 line-h">
                    <p className="mb-2 text-uppercase text-lgray3">mail to our sales department</p>
                    <a href="mailto:info@indtechmark.com" className="fn-24 fw-midem text-white" title="info@indtechmark.com">
              ...
              <div className="bg-red px-4 py-3 rounded-3 mt-4">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-3 line-h">
                    <p className="mb-2 text-uppercase text-white-50">our WhatsApp number</p>
                    <a href="https://wa.me/916232696232" className="fn-24 fw-midem text-white" title="+91 6232 69 6232">
                      +91 6232 69 6232
                    </a>
                  </div>
                </div>
            ...
            <div className="col-sm-6 col-md-8 outer-col-2">
              <div className="form-box ms-md-5">
                <div className="title mb-20 wow fadeInDown">
                  <form id="collaborateForm" method="post" className="form-horizontal" action="" name="collaborate-form" noValidate>
                          ...
                          <div className="col-lg-6 select-country">
                            <div className="mb-3 mb-lg-4 form-item line">
                              <div className="country-list collaborate-list">
                                <select id="country_name" className="js-example-placeholder-single js-states form-control font-16 in">
                          ...
                          <div className="form-item inputDnD inputfiles">
                            <div className="inside-div">
                              <span className="d-flex align-items-center">
                                ...
                                <p className="ms-1 font-18 mb-0">Attach a file</p>
                              </span>
                              <span className="para-text d-block text-left font-12">
                                Please upload a file with one of the following extensions: .pdf, .docx
                              </span>
                            </div>
                            <label className="file">
                              ...
                              />
                              <div style={{ display: 'none' }} id="file-upload-filename" className="align-items-center">
                                <span id="file-text-name"></span>
                                <a className="d-flex file-clear" href="javascript:void(0)">
            ...
            <div className="col-sm-12 col-md-4" data-aos="fade-up">
              <div className="pt-5">
                <div className="d-flex align-items-baseline">
                  <div className="me-1">
                    <img src={mapPinIcon} alt="Address" title="" width="21" height="20" className="pe-1" />
                  </div>
                  <h5 className="fn-face2 fn-16 text-white mb-2">Shishwachak, Punpun, Patna (804453)</h5>
                </div>
                <p className="mb-2">
                  <div className="d-flex align-items-baseline">
                    <div className="me-1">
                      <img className="pe-1" src={emailIcon} alt="Email" title="" width="21" height="20" />
                    </div>
                    <a className="fn-16 text-white" href="mailto:info@indtechmark.com" title="info@indtechmark.com">
                      info@indtechmark.com
                    </a>
                  </div>
                </p>
                <p className="">
                  <div className="d-flex align-items-baseline">
                    <div className="me-1">
                      <img className="pe-1" src={callIcon} alt="Call" title="" width="21" height="20" />
                    </div>
                    <a className="fn-16 text-white" href="tel:+91 6232 69 6232" title="+91 6232 69 6232">
                      +91 6232 69 6232
                    </a>
                  </div>
                </p>
